...
$sql = "SELECT order_date, client_name, client_contact, sub_total, vat, total_amount, discount, grand_total, paid, due, payment_place, gstn, cash, gcash, bank, date_today, credit_card FROM orders WHERE order_id = $orderId";
...
product.product_name, brands.brand_type FROM order_item
...
<div id="invoice-POS"> 
    ...
    <p><strong>Orders</strong></p>
            ...
            <tr class="service">
                ...
                <td class="tableitem"><u><p class="itemprice">- P'.number_format($discount,2).'</p></u></td>
            </tr>
            <tr class="service">
                <td class="tableitem"><p class="tabletitle"><strong>GrandTotal</strong></p></td>
                <td class="tableitem"><p class="itemprice"><strong>P'.number_format($grandTotal,2).'</strong></p></td>
            </tr></table>';
            ?>
        </div>
        <div id="table">
