...
$sql = "SELECT b.brand_name, b.brand_type, b.price, c.categories_name from brands b inner join categories c on b.brand_id = c.brand_id where c.categories_id = $categoriesId";
$result = $connect->query($sql);
while($row = $result->fetch_row()) {
	list($brandName, $brandType, $price, $categoriesName) = $row;
 }
	...
	<div class="col-md-12">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="page-heading"> <a href="<?php  echo $_SERVER['HTTP_REFERER'];?>"><i class="glyphicon glyphicon-circle-arrow-left"></i></a> Manage Product | <?php echo "$brandName | $categoriesName"; ?></div>
			</div> <!-- /panel-heading -->
			<div class="panel-body">
				...
				<input type="hidden" value="<?php echo $categoriesId; ?>" id="categoriesId"/>
	        ...
	        <div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      ...
				      <input type="hidden" id="brandName" name="brandName" value="<?php echo $brandId;?>"/>
				      <input type="hidden" id="categoryName" name="categoryName"value="<?php echo $categoriesId; ?>"/>
				    </div>
	        </div> <!-- /form-group-->	
	        <div class="form-group">
				<?php
				...
				<label class="col-sm-1 control-label">: </label>
					<div class="col-sm-8">
					<input type="number" class="form-control" value="<?php echo $price;?>" id="price" placeholder="Price/<?php echo $prod;?>" name="price" autocomplete="off" <?php echo $read;?>/>
					</div>
			</div> <!-- /form-group-->	
	        <div class="form-group">
	        	<label for="quantity" class="col-sm-3 control-label"><?php echo $prod; ?> </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="quantity" placeholder="<?php echo $prodType; ?>" name="quantity" autocomplete="off">
	      	...
	      	<div class="div-result">
				  ...
				  <div class="tab-content">
			        ...
			        <div class="form-group">
			        	...
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <select class="form-control" id="editBrandName" name="editBrandName" readOnly>
			        ...
			        <div class="form-group">
			        	...
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <select type="text" class="form-control" id="editCategoryName" name="editCategoryName"  readOnly>
						      	<option value="">~~SELECT~~</option>
						      	<?php 
