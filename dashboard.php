...
<div class="row">
	...
	<div class="col-md-8">
		<div class="panel panel-default">
			<div class="panel-heading"> <i class="glyphicon glyphicon-calendar"></i> Payment Type Revenue
			<div class="pull-right"><i class="fa fa-money"></i> <a href="expenses.php">Expenses</a></div>
			</div>
	...
	<?php  } else {?>
		...
		<div class="col-md-8">
		<div class="panel panel-default">
			<div class="panel-heading"> <i class="fa fa-money"></i> Expenses | <?php echo $curDate; ?></div><div class="pull-right"> <a href="expenses.php"><button><i class="glyphicon glyphicon-plus-sign"></i> Add Expenses</button></a></div> <!-- /div-action -->	
			<div class="panel-body">		
				<table class="table" id="revenueTable">
			  	<thead>
			  		<tr>			  			
