		...
		<?php if($_GET['o'] == 'add') { ?>			
  		...
  		<form class="form-horizontal" method="POST" action="php_action/createOrder.php" id="createOrderForm">
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-8">
			      <input type="text" class="form-control" id="orderDate" name="orderDate"value="<?php echo date('m/d/Y'); ?>" autocomplete="off"/>
			    </div>
			  </div> <!--/form-group-->
			</div>
			<div class="col-md-4">
			  	...
			  	<tbody>
			  		...
			  		for($x = 1; $x < 2; $x++) { ?>
			  			<tr id="row<?php echo $x; ?>" class="<?php echo $arrayNumber; ?>">			  				
			  				...
			  				<td>
								<select class="form-control" style="width:100%" name="productName[]" id="productName<?php echo $x; ?>" onchange="getProductData(<?php echo $x; ?>,0)" readonly>
									<option value="">~~SELECT~~</option>
								</select>
			  ...
			  <div class="col-md-8">	
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-9">
				      ...
				      <input type="hidden" class="form-control" value="1" name="paymentStatus" id="paymentStatus" />
				    </div>
				  </div> <!--/form-group-->						  
				  <!-- <div class="form-group">
		...
		// /else manage order
  		...
  		<form class="form-horizontal" method="POST" action="php_action/editOrder.php" id="editOrderForm">
			  ...
			  <div class="col-md-6">
				  ...
				  <div class="form-group">
				    <label for="vat" class="col-sm-3 control-label gst"><?php if($data[13] == 2) {echo "VAT 0%";} else echo "VAT 0%"; ?></label>
				    <div class="col-sm-9">
