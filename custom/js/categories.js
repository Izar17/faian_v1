...
function addCategories(categoriesId = null, brandId = null) {
	if(categoriesId) {
		$.ajax({
		url: 'php_action/fetchSelectedCategories.php',
		type: 'post',
		data: {brandId : brandId, categoriesId : categoriesId},
		dataType: 'json',
		success: function(response) {
			location.href= "product.php?brandId="+brandId+"&categoriesId="+categoriesId;
		//alert(categoriesId);
		},
		error: function(url) {
		   alert(error);
	...
	if(categoriesId) {
		...
		$.ajax({
			...
			success:function(response) {
				...
				// set the categories Grams
				$("#editQuantity").val(response.quantity);
				// set the categories Price
				$("#editPrice").val(response.rate);
...
function removeCategories(categoriesId = null, brandId = null) {
	$.ajax({
		url: 'php_action/fetchSelectedCategories.php',
		type: 'post',
		data: {categoriesId: categoriesId},
		...
		success:function(response) {			
			...
			$("#removeCategoriesBtn").unbind('click').bind('click', function() {
				...
				$.ajax({
					...
					type: 'post',
					data: {categoriesId: categoriesId, brandId: brandId},
					dataType: 'json',
					success:function(response) {
						if(response.success == true) {
 							// remove categories btn
